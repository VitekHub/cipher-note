...
describe('auth-credentials', () => {
  ...
  describe('signUpUser', () => {
    it('calls signup with username and authHash', async () => {
      await signUpUser('testuser', 'a'.repeat(64))
    ...
    it('sets loading false after error', async () => {
      vi.mocked(authAdapter.signup).mockRejectedValueOnce(new Error('signup failed'))

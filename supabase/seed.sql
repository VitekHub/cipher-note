...
--   ciphertext:       variable, minimum 32 chars (16 byte GCM auth tag)
--
...
-- ============================================
-- Master keys for testuser
-- ============================================
INSERT INTO public.master_keys (user_id, wrapped_master_key, master_key_iv)
VALUES (
  'a0eebc99-9c0b-4ef8-bb6d-6bb6513e5e0a',
...
-- ============================================
INSERT INTO public.encrypted_fields (entry_id, user_id, field_name, ciphertext, ciphertext_iv)
VALUES
